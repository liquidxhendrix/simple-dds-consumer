...
data type ShapeType from ShapeType.idl.
...
> objs/x64Linux4gcc7.3.0/ShapeType_publisher <domain_id> <sample_count>
> objs/x64Linux4gcc7.3.0/ShapeType_subscriber <domain_id> <sample_count>
